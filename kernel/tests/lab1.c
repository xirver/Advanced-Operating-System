...
void lab1_check_split_and_merge(int flags)
{
...
#ifdef BONUS_LAB1
	if (flags & ALLOC_HUGE)
		cprintf("[LAB 1] check_split_and_merge() for huge pages succeeded!\n");
	else
#endif
...
#ifdef BONUS_LAB1
	lab1_check_split_and_merge(ALLOC_HUGE);
#endif
