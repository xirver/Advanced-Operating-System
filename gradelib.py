...
__all__ += ["test", "bonus", "end_part", "run_tests", "get_current_test"]
...
""")
    ...
    def user_test(self, binary, *monitors, **kw):
        ...
        maybe_unlink("obj/kernel/init.o", "obj/kernel/kernel")
...
def stop_breakpoint(addr):
    ...
    def setup_breakpoint(runner):
        if isinstance(addr, str):
            addrs = [int(sym[:16], 16) for sym in open("obj/kernel/kernel.sym")
